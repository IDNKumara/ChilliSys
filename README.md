...
- **Role-Based Access:** Tailored dashboards and features for Suppliers, Buyers, and Admins.
- **Interactive Charts:** Visual analysis of price trends and predictions.
- **Messaging System:** Direct communication between Suppliers and Buyers.
- **Order Management:** Full order lifecycle management (Place, Accept, Complete, Cancel).

## User Roles & Capabilities

### 1. Supplier (Farmers/Distributors)
Suppliers are the backbone of the system, providing the produce.
*   **Manage Inventory:** Add, Update, and Delete chili stocks.
*   **Order Management:** Receive, Accept, and Complete orders from buyers.
*   **Messaging:** Communicate directly with buyers.
*   **Price Intelligence:** Use the prediction tool to decide the best time to sell.

### 2. Buyer (Retailers/Shops)
Buyers use the system to source produce and plan purchases.
*   **Marketplace Access:** Browse and Buy from real-time inventory.
*   **Order Tracking:** Track status of placed orders.
*   **Messaging:** Contact suppliers for negotiations.
*   **Price Intelligence:** Anticipate price drops.

### 3. Administrator
Admins oversee the entire system.
*   **User Management:** View, Manage, and Delete user accounts.
*   **System Oversight:** Monitor all orders and inventory.
...
### Key Endpoints
*   **Auth**: `/users/token`, `/users/`
*   **Inventory**: `/inventory/` (GET, POST, PUT, DELETE)
*   **Orders**: `/orders/` (GET, POST), `/orders/{id}/status` (PATCH)
*   **Messages**: `/messages/` (POST), `/messages/inbox` (GET)
